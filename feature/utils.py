...
def resample_minute(series, freq, op):
    ...
    flag=series.index.hour*10000+series.index.minute*100+series.index.second
    return series[(flag!=93000)&(flag!=130000)]
...
#
# from feature.ops import Shift, Rolling
#
#
...
def series_frequance(series):
    return FREQUANCE_TICK if series.index[0]>10000101093003 else( FREQUANCE_DAY if series.index[0] < 30000000 else FREQUANCE_MINUTE )# 判断并生成feature的频率
