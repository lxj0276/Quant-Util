...
class CCI14_Daily(PersistentFeature):
    ...
    #     TP = Map(Add(Add(feature.Close_Daily(), feature.Low_Daily()), feature.High_Daily()), lambda x:x/3)
    #     ma = MA(feature.Close_Daily(), 14)
    #     MD = MA(Sub(ma, feature.Close_Daily()), 14)
    #     CCI = Map(Div(Sub(TP, ma), MD), lambda x:x/0.015)
